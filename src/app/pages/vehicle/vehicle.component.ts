...
export class VehicleComponent implements OnInit {
  ...
  destroyVehicle() {
    this._vehicles.delete(this.id).subscribe(params => {
      console.log(params);
      this.message = 'Se ha eliminado con exito, recuerde refrescar la tabla de inicio.';
    }, error1 => {
      console.log(error1);
      this.message = 'No se ha podido eliminar, por favor revise su conexión a internet';
    });
  }
